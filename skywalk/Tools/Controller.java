...
public class Controller {
    ...
    public Controller(SpriteBatch spriteBatch) {
        ...
        viewport = new FitViewport(Skywalk.V_WIDTH, Skywalk.V_HEIGHT, camera);
        ...
        table.add(buttonUp).size(buttonUp.getWidth(), buttonUp.getHeight()).padLeft(260);
        table.add();
